...
# path  
#path = r'C:\Users\sjccuser\Downloads\cis_024c_05112020_headlines\headlines\templates\065-Problem-AP-Calculus-Review.jpg'
...
while True: 
	...
	cv2.putText(frame, "", (298, 33), 
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, 
				(255, 255, 255), 2, cv2.LINE_AA) 
	
	cv2.putText(frame, "", (420, 33), 
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, 
				(255, 255, 255), 2, cv2.LINE_AA) 
	
	cv2.putText(frame, "", (520, 33), 
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, 
